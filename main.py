...
def main(args):
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        if test_stats["acc1"] > max_accuracy:
            if args.output_dir:
                checkpoint_paths = [output_dir / '{}_{}_checkpoint_{}.pth'.format(args.model, args.data_set, args.uni_note)]
        ...
        if args.output_dir and utils.is_main_process():
            with (output_dir / "{}_{}_log_{}.txt".format(args.model, args.data_set, args.uni_note)).open("a") as f:
